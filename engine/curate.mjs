...
HOUSE STYLE for every sentence you write (use_case, basis_en, basis_fr, confidence_reason): never use a dash as punctuation, whether —, – or a spaced " - ". Use a comma, a colon, parentheses or a new sentence instead. Write ranges with words ("3 to 6 hours", "de 3 à 6 heures"), not "3-6".
