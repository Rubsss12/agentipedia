...
const T = {
  fr: {
    ...
    success: "Merci ! Votre demande est bien partie. Notre équipe vous recontacte sous 24h.",
  ...
  en: {
    ...
    success: "Thank you! Your request is on its way. Our team gets back to you within 24h.",
